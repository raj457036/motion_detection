...
class ImageUtils {
  ...
  static imageLib.Image? convertCameraImage(CameraImage cameraImage) {
    if (cameraImage.format.group == ImageFormatGroup.yuv420) {
      ...
      return imageLib.JpegDecoder().decodeImage(cameraImage.planes[0].bytes);
    }
    return null;
  }
  ...
  static Uint8List getImageBytes(imageLib.Image image) {
    final List<int> jpeg = imageLib.JpegEncoder().encodeImage(image);
    return jpeg as Uint8List;
  }
}
